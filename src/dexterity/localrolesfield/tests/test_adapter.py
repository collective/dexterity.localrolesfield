...
class TestAdapter(unittest.TestCase):
    ...
    def test_getRoles_private(self):
        ...
        self.assertEqual(("Editor", "Reader"), adapter.getRoles("mail_editor"))
        self.assertEqual(("Contributor", "Reader"), adapter.getRoles("mail_reviewer"))
    ...
    def test_getRoles_published(self):
        ...
        self.assertEqual((), adapter.getRoles("support_editor"))
        self.assertEqual((), adapter.getRoles("support_reviewer"))
        self.assertEqual(("Reader",), adapter.getRoles("mail_editor"))
        self.assertEqual(("Editor", "Contributor", "Reader"), adapter.getRoles("mail_reviewer"))
    ...
    def test_field_and_values_list(self):
        ...
        self.assertEqual(field_values, sorted(self._adapter.field_and_values_list))
